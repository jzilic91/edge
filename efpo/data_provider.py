...
class DataProvider:
	...
	def __parse_dataset(cls):
		...
		cls._fat_nodes_failure_provider = FailureProvider(fat_nodes_failures, cls._total_time)
		cls._thin_nodes_failure_provider = FailureProvider(thin_nodes_failures, cls._total_time)
		cls._lustre_servers_failure_provider = FailureProvider(lustre_servers_failures, cls._total_time)
		cls._net_failure_provider = FailureProvider(net_failures, cls._total_time)
		cls._other_thin_nodes_failure_provider = FailureProvider(other_thin_nodes_failures, cls._total_time)
